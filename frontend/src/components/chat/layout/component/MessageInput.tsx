...
const MessageInput = ({ selectedConvo }: { selectedConvo: Conversation }) => {
  ...
  return (
    <div className="flex items-center gap-2 p-3 min-h-[56px] bg-background">
      ...
      <Button onKeyPress={handleKeyPress} onClick={sendMessage} className="bg-gradient-chat hover:shadow-glow transition-smooth hover:scale-105" disabled={!value.trim()}>
